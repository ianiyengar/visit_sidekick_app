...
Note.create!({ client_id: 1, date: "7/23/2021", content: "Nathan did very well. He coninues to improve each week.", name: "Nathan Taylor" })
Note.create!({ client_id: 2, date: "7/25/2021", content: "Daniel did OK. He coninues to improve on his skills.", name: "Daniel Deuel" })
